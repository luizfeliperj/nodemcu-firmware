...
#define OP_Ne             32 /* same as TK_NE, synopsis: IF r[P3]!=r[P1]   */
#define OP_Eq             33 /* same as TK_EQ, synopsis: IF r[P3]==r[P1]   */
#define OP_Gt             34 /* same as TK_GT, synopsis: IF r[P3]>r[P1]    */
#define OP_Le             35 /* same as TK_LE, synopsis: IF r[P3]<=r[P1]   */
#define OP_Lt             36 /* same as TK_LT, synopsis: IF r[P3]<r[P1]    */
#define OP_Ge             37 /* same as TK_GE, synopsis: IF r[P3]>=r[P1]   */
#define OP_ElseNotEq      38 /* same as TK_ESCAPE                          */
...
/*  32 */ 0x0b, 0x0b, 0x0b, 0x0b, 0x0b, 0x0b, 0x01, 0x26,\
/*  40 */ 0x26, 0x26, 0x26, 0x26, 0x26, 0x26, 0x26, 0x26,\
/*  48 */ 0x26, 0x09, 0x12, 0x09, 0x09, 0x09, 0x01, 0x01,\
...
/*  96 */ 0x00, 0x00, 0x00, 0x10, 0x10, 0x10, 0x00, 0x00,\
